...
#include "HotelDataStrucAlgoQueuesHeader.h"
#include <stdbool.h>
#include <string.h>
    ...
    while(choice != 6) {
        switch(choice) {
            ...
            case 3:
                ...
                enqueue(&headPtr, &tailPtr, guestId, roomNumber, roomPrice, guestName, guestGender, guestEmail); // enqueue
            ...
            case 4:
                ...
                if(!isEmptyQueue(headPtr))
                {
                    dequeue(&headPtr, &tailPtr, guestId);
                }
                printQueue(headPtr);
                break;
